...
yes_thats_right = TwoAnswers("Yes, that's right -- a rock.\nYou are just a rock, technically a mineral. " 
	                    "You are not somebody's pet rock. You are not cute. You do not have googly eyes. " 
			    "The ridges of your exterior do not resemble a smily face -- no, not even " 
			    "when I squint.\n\nDo you understand?\n     1 - Yes\n     2 - No", "No you don't\n",
			    "Of course you don't.\n", "", "", "")

pressure = OneAnswer("The sensation you feel most intensely is heaviness.  Though . . . is " 
...
#	                        "that at one time, you crystalized -- literally?\ nHow did it feel?")
